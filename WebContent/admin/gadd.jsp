...
<body>
	<%-- 	<img alt="" src="http://127.0.0.1:8080/xiangmu/upload/${img}" /> --%>
						...
						<div class="box-content">
							<div id="contact_form" style="width: 800px; height: 700px;">
								<form enctype="multipart/form-data"
									action="${pageContext.request.contextPath}/gadd.htmlx"
									method="post">
									<div align="center" style="width: 500px; height: 300px;">
										<label> <span>新增管理员名</span> <input type="text"
											name="uname" placeholder="请输入新增的管理员名" />
										</label> <label> <span>新增管理员密码</span> <input type="password"
											name="upass" placeholder="请输入您的管理员密码" />
