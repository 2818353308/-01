...
<body style="padding: 10px;">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="page-body">
				<form id="query" action="${pageContext.request.contextPath}/queryuser.htmlx" class="form-inline" role="form" method="post">
				</form>
			</div>
		</div>
		<div class="panel-body">
			...
			<c:forEach var="item" items="${pageVo.result3}">
					<tr>
						<td>${item.uname }</td>
						 <td>${item.sex }</td>
						 <td><img alt="" style="border-radius: 50%;" height="50px;" width="50px;" src="${pageContext.request.contextPath}/${item.head_portrait }"></td>	
					</tr>
			</c:forEach> 
				<tfoot>
					<tr>
