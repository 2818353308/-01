...
<body style="padding: 10px;">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">管理员查询</h3>
		</div>
		<div class="panel-body">
			<div class="page-body">
				<form id="query" action="${pageContext.request.contextPath}/query1.htmlx" class="form-inline" role="form" method="post">
				</form>
			</div>
		</div>
		<div class="panel-body">
			...
			<c:forEach var="item" items="${pageVo.result3}">
					<tr>
						<td>${item.uname }</td>
						 <td><img alt="" style="border-radius: 50%;" height="50px;" width="50px;" src="${pageContext.request.contextPath}/${item.guan_image }"></td>	
					</tr>
			</c:forEach> 
				<tfoot>
					<tr>
