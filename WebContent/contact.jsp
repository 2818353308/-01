...
<head>
	...
	<!-- Owl Carousel Assets -->
    <link href="${pageContext.request.contextPath}/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/owl-carousel/owl.theme.css" rel="stylesheet">
...
<!-- 						<li><a href="contact.jsp"><i class="fa fa-comments"></i>联系我们</a></li> -->
						<li><a href="${pageContext.request.contextPath}/tiezi.jsp"><i class="fa fa-question-circle"></i> 发帖</a></li>
						<c:choose>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">右友圈<i class="fa fa-arrow-circle-o-down"></i></a>
					<div class="dropdown-menu">
						<div class="dropdown-inner">
							<ul class="list-unstyled">
							    <li><a href="${pageContext.request.contextPath}/queryGpost.htmlx?params['g_type']=搞笑">搞笑</a></li>
								<li><a href="${pageContext.request.contextPath}/queryGpost.htmlx?params['g_type']=娱乐">娱乐</a></li>
...
<%-- 								<li><a href="${pageContext.request.contextPath}/xianshi.htmlx?params['post_type']=情感">情感</a></li> --%>
				...
				<li><a href="${pageContext.request.contextPath}/contact.jsp"><i class="fa fa-envelope"></i>联系我们</a></li>
			</ul>
				...
				<div id="main-content" class="col-md-8">
					<div class="box">
						<center><div class="box-header">
							<h1 class="center"><i class="fa fa-envelope"></i>联系我们</h1>
						</div>
						...
						<div class="box-content">
							...
							<div id="contact_form">
								<form name="form1" id="ff" method="post" action="${pageContext.request.contextPath}/user/add_feedback.htmlx">
									<label>
									<span>用户名:</span>
									<input type="text" value="${loginUser.uname }"  name="f_name" id="name" required>
									</label>
									<label>
									<span>email邮箱:</span>
									<input type="email"  name="f_email" id="email" required>
									</label>
									<label>
									<span>内容:</span>
									<textarea name="f_content" id="message"></textarea>
									</label>
